...
datadg{1} = load_data('/Volumes/lab/analysis/2016-01-30-0/data000-map/data000-map', opt);
datadg{1}.names.stimulus_path = '/Volumes/lab/analysis/2016-01-30-0/stimuli/s00.mat';
datadg{1} = load_stim_matlab(datadg{1}, 'user_defined_trigger_interval', 10);
datadg{2} = load_data('/Volumes/lab/analysis/2016-01-30-0/data004-map/data004-map', opt);
datadg{2}.names.stimulus_path = '/Volumes/lab/analysis/2016-01-30-0/stimuli/s04.mat';
datadg{2} = load_stim_matlab(datadg{2}, 'user_defined_trigger_interval', 10);
datadg{3} = load_data('/Volumes/lab/analysis/2016-01-30-0/data007-map/data007-map', opt);
datadg{3}.names.stimulus_path = '/Volumes/lab/analysis/2016-01-30-0/stimuli/s07.mat';
datadg{3} = load_stim_matlab(datadg{3}, 'user_defined_trigger_interval', 10);
datadg{4} = load_data('/Volumes/lab/analysis/2016-01-30-0/data010-map/data010-map', opt);
datadg{4}.names.stimulus_path = '/Volumes/lab/analysis/2016-01-30-0/stimuli/s10.mat';
datadg{4} = load_stim_matlab(datadg{4}, 'user_defined_trigger_interval', 10);
datadg{5} = load_data('/Volumes/lab/analysis/2016-01-30-0/data013-map/data013-map', opt);
datadg{5}.names.stimulus_path = '/Volumes/lab/analysis/2016-01-30-0/stimuli/s13.mat';
datadg{5} = load_stim_matlab(datadg{5}, 'user_defined_trigger_interval', 10);

datamb{1} = load_data('/Analysis/xyao/2016-01-30-0/data001-map/data001-map', opt);
datamb{1}.names.stimulus_path = '/Analysis/xyao/2016-01-30-0/stimuli/s01.mat';
datamb{1} = load_stim_matlab(datamb{1});
datamb{2} = load_data('/Analysis/xyao/2016-01-30-0/data005-map/data005-map', opt);
datamb{2}.names.stimulus_path = '/Analysis/xyao/2016-01-30-0/stimuli/s05.mat';
datamb{2} = load_stim_matlab(datamb{2});
datamb{3} = load_data('/Analysis/xyao/2016-01-30-0/data008-map/data008-map', opt);
datamb{3}.names.stimulus_path = '/Analysis/xyao/2016-01-30-0/stimuli/s08.mat';
datamb{3} = load_stim_matlab(datamb{3});
datamb{4} = load_data('/Analysis/xyao/2016-01-30-0/data011-map/data011-map', opt);
datamb{4}.names.stimulus_path = '/Analysis/xyao/2016-01-30-0/stimuli/s11.mat';
datamb{4} = load_stim_matlab(datamb{4});
datamb{5} = load_data('/Analysis/xyao/2016-01-30-0/data014-map/data014-map', opt);
datamb{5}.names.stimulus_path = '/Analysis/xyao/2016-01-30-0/stimuli/s14.mat';
datamb{5} = load_stim_matlab(datamb{5});

dataffp{1} = load_data('/Volumes/lab/analysis/2016-01-30-0/data002-map/data002-map', opt);
dataffp{1}.triggers = dataffp{1}.triggers(2:end);
dataffp{2} = load_data('/Volumes/lab/analysis/2016-01-30-0/data006-map/data006-map', opt);
dataffp{2}.triggers = dataffp{2}.triggers(2:end);
dataffp{3} = load_data('/Volumes/lab/analysis/2016-01-30-0/data009-map/data009-map', opt);
dataffp{3}.triggers = dataffp{3}.triggers(2:end);
dataffp{4} = load_data('/Volumes/lab/analysis/2016-01-30-0/data012-map/data012-map', opt);
dataffp{4}.triggers = dataffp{4}.triggers(2:end);
dataffp{5} = load_data('/Volumes/lab/analysis/2016-01-30-0/data015-map/data015-map', opt);
