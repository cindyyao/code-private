...
if(threed)
    ...
    for i = 1:nclusters
        if i ==1
            scatter3(X(idx==i,1),X(idx==i,2),X(idx==i,3),30,[0 0 1]);
        elseif i == 2;
            scatter3(X(idx==i,1),X(idx==i,2),X(idx==i,3),30,[1 0 0]);
        end
    hold on
    end
...
if(twod)
    ...
    for i = 1:nclusters
        if i ==1
            scatter(X(idx==i,1),X(idx==i,2),30,[0 0 1]);
        elseif i ==2
                scatter(X(idx==i,1),X(idx==i,2),30,[1 0 0]);
        end
    hold on
    end
