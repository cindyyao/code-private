...
path = '/Volumes/dusom_fieldlab/All_Staff/lab/Experiments/Array/Analysis/2019-07-10-0/';
...
[ds_id, nonds_id] = classify_ds(datadg, ds_struct, params_idx, 'manual', true);
