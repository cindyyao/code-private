...
% datadg = load_data('/Volumes/lab/Experiments/Array/Analysis/2019-01-14-0/data006/data006', opt);
% datadg.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-14-0/stimuli/s06.txt';
% datadg = load_stim(datadg, 'user_defined_trigger_interval', 10);
% 
datadg = load_data('/Volumes/lab/Experiments/Array/Analysis/2019-01-14-0/data006-sorted/data006-sorted', opt);
datadg.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-14-0/stimuli/s06.txt';
datadg = load_stim(datadg, 'user_defined_trigger_interval', 10);
...
datarun = load_data('/Volumes/lab/Experiments/Array/Analysis/2019-01-14-0/data-flashes/data-flashes', opt);
dataflash = split_datarun(datarun, [3874 7630]);
...
dataflash{3}.DfParams.NDF =   [5,5,5,5,4,4,4,3,3,3,2,2,1] ; % on filter turret 
dataflash{3}.DfParams.Ftime = [1,2,4,8,2,4,8,2,4,8,2,8,2] ; % ms
...
% id_dir_flash{2}([4 6 8 10 12 14 15 17]) = [];
% idx_dir_flash{2}([4 6 8 10 12 14 15 17]) = [];
% id_dir_flash{1}([4 13 15 16 17]) = [];
% idx_dir_flash{1}([4 13 15 16 17]) = [];
% 
%% parameters
...
for cc = 1:length(ds_id_flash);
    ...
    print_close(1, [24 14], num2str(ds_id_flash(cc)))
