...
datadg = load_data('/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/data007-sorted/data007-sorted', opt);
datadg.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/stimuli/s07.txt';
...
load('DS190107.mat')
datarun = load_data('/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/data001-005-map/data001-005-map', opt);
time_points = [2400 4800];
datamfs(1:3) = split_datarun(datarun, time_points);
datamfs{1}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/stimuli/s01.mat';
datamfs{1} = load_stim_mfs(datamfs{1});

datamfs{2}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/stimuli/s03.mat';
datamfs{2} = load_stim_mfs(datamfs{2});

datamfs{3}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2019-01-07-0/stimuli/s05.mat';
...
for ds = 1:3
    ...
    %                     Gaussian_params{ll}{dir}{cc}{onoff} = params;
            ...
            rf_area{ds}{dir}{onoff} = rf_area_temp(rf_area_temp < 0.5);
...
%     set(gca, 'yscale', 'log')
    legend([h(1), h(2), h(3)], 'control', 'SR', 'wash')
    if onoff == 1
        title('ON')
    else
        title('OFF')
