function[ds_struct] = dscellanalysis_photon(NumSpikesCell, StimComb,datarun)
...
mag = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
MAG = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
dsindex = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
angle = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
rho = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
RHO = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
theta = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
U = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
V = cell(length(unique(cell2mat(StimComb(:,2)))), length(unique(cell2mat(StimComb(:,1)))));
