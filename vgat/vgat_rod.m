...
cell_type = {'ON brisk transient', 'ON transient', 'OFF brisk transient', 'OFF slow'};
...
%     set(h_legend,'FontSize',14);
    ...
    % temporal profile
    subplot(2, 4, 6)
    t1 = -0.01657*refresh_rate(1)*[14:-1:0];
    t2 = -0.01657*refresh_rate(2)*[14:-1:0];
...
% surround strengths
    ...
    legend('WT','VGAT-/-', 'location', 'northwest');
    hold on;
...
save('VGAT_rod.mat', 'Spatial_Profile', 'Temporal_Filter', 'sta_c', '-append')
