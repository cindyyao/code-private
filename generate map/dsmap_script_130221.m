wn_map_path = '/Volumes/Dvorak/analysis/xyao/2013-02-21-0/data004-map/data004-map';
wn_path = '/Volumes/Dvorak/analysis/xyao/2013-02-21-0/data004/data004';
...
%                 \ /                               ------
%                455 (4)                         264(6) 386(5)  
array_location_display = [186 291; 232 193; 346 193; 398 288];
...
on1 = get_cell_ids(datawn, 'ON brisk transient');
on2 = get_cell_ids(datawn, 'ON transient');

off1 = get_cell_ids(datawn, 'OFF brisk transient');
off2 = get_cell_ids(datawn, 'OFF transient');
off3 = get_cell_ids(datawn, 'OFF sustained');
...
%% get DS cell id
dg_path = '/Volumes/Dvorak/analysis/xyao/2013-02-21-0/data008/data008';
dg_stimulus_path = '/Volumes/Dvorak/analysis/xyao/2013-02-21-0/stimuli/s08';
