...
datarun{2} = load_data('/Analysis/xyao/2013-02-21-0/data002/data002', opt);
datarun{3} = load_data('/Analysis/xyao/2013-02-21-0/data004/data004', opt);
...
for i = 1:n
    ...
    fit_temp = fit_sta_sequence(sta_c{ll}{i});
...
save('RFS130221_nomap.mat', 'fit_sta_c', 'params_c', 'sta_f_weighted', 'sta_c')
...
figure
a = [-4 -2 0];
plot(a, ratio_all(1, :), 'marker', 'x', 'color', 'b')
hold on
plot(a, ratio_all(3, :), 'marker', 'x', 'color', 'r')
plot(a, ratio_all(4, :), 'marker', 'x', 'color', 'c')

plot(a(2:3), ratio_all(5, 2:3), 'marker', 'x', 'color', 'y')

legend(cell_type{[1 3 4 5]}, 'Location', 'northeastoutside')
