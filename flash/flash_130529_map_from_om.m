...
datarun{1} = load_data('/Analysis/xyao/2013-05-29-0/data005/data005', opt);
% datarun{1} = load_params(datarun{1}, 'cell_type_depth', 1);

opt = struct('verbose',1,'load_params',1,'load_neurons',1, 'load_ei',1);
datarun{2} = load_data('/Analysis/xyao/2013-05-29-0/data004-map-from-om/data004-map-from-om', opt);
