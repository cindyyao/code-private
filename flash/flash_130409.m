...
datarun{1} = load_data('/Analysis/xyao/2013-04-09-0/data004/data004', opt);
% datarun{1} = load_params(datarun{1}, 'cell_type_depth', 1);
datarun{2} = load_data('/Analysis/xyao/2013-04-09-0/data003/data003', opt);

% datarun{1} = load_data('/Analysis/xyao/2013-04-09-0/data004/data004', opt);
% datarun{2} = load_data('/Analysis/xyao/2013-04-09-0/data000/data000', opt);

% datarun{1} = load_data('/Analysis/xyao/2013-04-09-0/data012/data012', opt);
% datarun{2} = load_data('/Analysis/xyao/2013-04-09-0/data010/data010', opt);
...
% datarun{2}.names.stimulus_path = '/lab/Analysis/2013-04-09-0/stimuli/s00';

datarun{2}.names.stimulus_path = '/Volumes/lab/Analysis/2013-04-09-0/stimuli/s03';

% datarun{2}.names.stimulus_path = '/lab/Analysis/2013-04-09-0/stimuli/s10';
...
% cell_type = {'on brisk transient', 'off brisk transient', 'off sustained', 'off transient'};
% cell_type = {'on', 'off'};
...
for i = 1:light_level
    ...
    if i == 1
        title(['cell id   ' num2str(cell_id{cell_type_n}(cell_n))]);
    end
