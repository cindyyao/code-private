...
% load stimulus for drifting gratings data
datarun{2}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2013-02-21-0/stimuli/s03';
datarun{2} = load_stim(datarun{2});
...
% load stimulus for drifting gratings data
datarun{2}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2013-02-21-0/stimuli/s01';
datarun{2} = load_stim(datarun{2});
...
% load stimulus for drifting gratings data
datarun{2}.names.stimulus_path = '/Volums/lab/Experiments/Array/Analysis/2013-02-14-0/stimuli/s07';
datarun{2} = load_stim(datarun{2});
...
% load stimulus for drifting gratings data
datarun{2}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2013-02-14-0/stimuli/s04';
datarun{2} = load_stim(datarun{2});
...
% load stimulus for drifting gratings data
datarun{2}.names.stimulus_path = '/Volumes/lab/Experiments/Array/Analysis/2013-02-14-0/stimuli/s01';
datarun{2} = load_stim(datarun{2});
...
%%
load('spatial_tuning0221.mat')
surround_strengths = [surround_strengths_ndf4 0; surround_strengths_ndf2; surround_strengths_ndf0];
surround_strengths = surround_strengths';

NDF = [-4 -2 0];
figure
plot(NDF, surround_strengths(1:4, :));
hold on
plot(NDF(2:3), surround_strengths(5, 2:3), 'y');
legend(cell_type, 'Location', 'northeastoutside')
xlabel('log of light intensity')
