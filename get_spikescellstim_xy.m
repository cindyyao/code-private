function[NumSpikesCell, StimComb, NumSpikesCellAll] = get_spikescellstim_xy(datarun,cellids,totaldur)
...
%Xiaoyang Yao revised at 12-13-2013
          
          
%Initialize output matrices    
NumSpikesCellAll = zeros(length(cellids), length(datarun.stimulus.combinations), datarun.stimulus.repetitions);
...
for k = 1:length(cellids)
    ...
    NumSpikesCellAll(k, :, :) = NumSpikesAll(index);
end
